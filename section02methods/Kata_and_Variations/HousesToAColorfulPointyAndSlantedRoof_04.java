...
public class HousesToAColorfulPointyAndSlantedRoof_04
{
  ...
  //
  //Make a skyline with colorful houses
  //Make a skyline with pointy roof houses and slanted roof houses but a different color
  //Make a house with a slanted roof and a height of 120 pixels but a different color
  //make a house with a pointy roof and a height of 90 pixels but a different color
  //make a house with a slanted roof and a height of 20 pixels but a different color
  //
  ...
  private static void drawCircleRoof(int height)
  {
    Tortoise.setPenColor(PenColors.Yellows.DarkKhaki);
